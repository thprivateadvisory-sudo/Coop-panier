...
const styles = StyleSheet.create({
  ...
  statusText: { fontFamily: 'Inter-Regular', fontSize: 12, fontWeight: '500' },
  ...
  pickupName: { fontFamily: 'Nunito-ExtraBold', fontSize: 18, color: colors.gris },
  pickupAddress: { fontFamily: 'Inter-Regular', fontSize: 14, color: colors.grisMoyen },
  hoursGrid: { marginTop: spacing.sm, gap: 4 },
  hoursRow: { flexDirection: 'row', justifyContent: 'space-between' },
  hoursDay: { fontFamily: 'Inter-Regular', fontSize: 13, color: colors.grisMoyen },
  hoursValue: { fontFamily: 'Inter-Regular', fontSize: 13, color: colors.gris, fontWeight: '500' },
  ...
  infoStep: { fontFamily: 'Inter-Regular', fontSize: 13, color: colors.grisMoyen, lineHeight: 20 },
  ...
  emptyTitle: { fontFamily: 'Nunito-Black', fontSize: 24, color: colors.gris },
  emptySub: {
    fontFamily: 'Inter-Regular',
    fontSize: 15,
    color: colors.grisMoyen,
