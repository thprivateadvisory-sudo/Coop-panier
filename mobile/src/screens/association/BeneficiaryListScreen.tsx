...
const styles = StyleSheet.create({
  ...
  back: { fontFamily: 'Inter-Regular', fontSize: 15, color: colors.vert },
  title: { fontFamily: 'Nunito-ExtraBold', fontSize: 18, color: colors.gris },
  ...
  summaryCount: { fontFamily: 'Nunito-Black', fontSize: 18 },
  summaryLabel: { fontFamily: 'Inter-Regular', fontSize: 10, textAlign: 'center' },
  ...
  avatarText: { fontFamily: 'Nunito-ExtraBold', fontSize: 16, color: colors.vert },
  info: { flex: 1 },
  name: { fontFamily: 'Nunito-Bold', fontSize: 15, color: colors.gris },
  sub: { fontFamily: 'Inter-Regular', fontSize: 12, color: colors.grisMoyen, marginTop: 2 },
  nextDate: { fontFamily: 'Inter-Regular', fontSize: 11, color: colors.grisClair, marginTop: 1 },
  ...
  toggleText: { fontFamily: 'Inter-Regular', fontSize: 11, color: colors.grisMoyen, textDecorationLine: 'underline' },

  empty: { fontFamily: 'Inter-Regular', fontSize: 14, color: colors.grisMoyen, textAlign: 'center', paddingTop: spacing.xxl },
});
