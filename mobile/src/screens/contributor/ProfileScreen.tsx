...
const styles = StyleSheet.create({
  ...
  avatarText: { fontFamily: 'Nunito-Black', fontSize: 26, color: colors.blanc },
  nameBlock: { alignItems: 'center', gap: 4 },
  name: { fontFamily: 'Nunito-ExtraBold', fontSize: 20, color: colors.gris },
  email: { fontFamily: 'Inter-Regular', fontSize: 13, color: colors.grisMoyen },
  city: { fontFamily: 'Inter-Regular', fontSize: 13, color: colors.grisMoyen, marginTop: 2 },
  ...
  editBtnText: { fontFamily: 'Nunito-Bold', fontSize: 14, color: colors.gris },
  saveBtn: {
    backgroundColor: colors.vert,
    borderRadius: radius.md,
    paddingVertical: 10,
  ...
  saveBtnText: { fontFamily: 'Nunito-ExtraBold', fontSize: 14, color: colors.blanc },
  cancelText: { fontFamily: 'Inter-Regular', fontSize: 14, color: colors.grisMoyen },
  ...
  subLabel: { fontFamily: 'Inter-Regular', fontSize: 12, color: colors.grisMoyen, marginBottom: 2 },
  subTier: { fontFamily: 'Nunito-Black', fontSize: 20 },
  subExpiry: { fontFamily: 'Inter-Regular', fontSize: 11, color: colors.grisMoyen, marginTop: 2 },
  upgradeBtn: {
    borderRadius: radius.md,
    paddingVertical: 8,
    paddingHorizontal: spacing.md,
  },
  upgradeBtnText: { fontFamily: 'Nunito-ExtraBold', fontSize: 13, color: colors.blanc },
  ...
  statValue: { fontFamily: 'Nunito-Black', fontSize: 20, color: colors.vert },
  statLabel: { fontFamily: 'Inter-Regular', fontSize: 10, color: colors.grisMoyen, textAlign: 'center' },
  ...
  signOutText: { fontFamily: 'Nunito-ExtraBold', fontSize: 15, color: colors.error },
